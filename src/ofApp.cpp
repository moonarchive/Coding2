...
void ofApp::audioOut(ofSoundBuffer& output){
    ...
    for (int i = 0; i < output.getNumFrames(); ++i){
        ...
        //output[i * outChannels] = myOsc1.sinewave(myFreq + (myOsc2.sinewave(440)*100)) * 0.5;
        //output[i * outChannels] = (myOsc1.sinewave(101) * myOsc2.sinewave(200) * 1.2)* (myOsc3.sinewave(0.5 + (myOsc4.sinewave(60) * 10)) * 2.0);
        output[i * outChannels] = (myOsc1.sinewave(101) * myOsc2.sinewave(200) * 1.2) * (myOsc3.sinewave(myFreq + (myOsc4.sinewave(60) * 10)) * 0.6);
